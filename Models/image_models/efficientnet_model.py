"""
Image Model 2 — EfficientNet-B0 (Pretrained, Fine-tuned)
==========================================================
Lighter and faster than ResNet50, often better accuracy on small datasets.

Run:  python efficientnet_model.py
Saves: Models/image_models/saved/efficientnet_model.pth
...
MODEL_SAVE = os.path.join(SAVE_DIR, "efficientnet_model.pth")
